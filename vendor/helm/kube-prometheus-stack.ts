...
export interface KubeprometheusstackProps {
...
export class Kubeprometheusstack extends Construct {
  public constructor(scope: Construct, id: string, props: KubeprometheusstackProps = {}) {
    super(scope, id);
    let updatedProps = {};
