...
export class HelmChart extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:source.toolkit.fluxcd.io/v1beta2:HelmChart';
     ...
     */
    public readonly spec!: pulumi.Output<outputs.source.v1beta2.HelmChartSpec | undefined>;
    /**
     * HelmChartStatus records the observed state of the HelmChart.
     */
    public readonly status!: pulumi.Output<outputs.source.v1beta2.HelmChartStatus | undefined>;
    ...
    constructor(name: string, args?: HelmChartArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["spec"] = args ? (args.spec ? pulumi.output(args.spec).apply(inputs.source.v1beta2.helmChartSpecArgsProvideDefaults) : undefined) : undefined;
...
export interface HelmChartArgs {
     ...
     * HelmChartSpec specifies the desired state of a Helm chart.
     */
    spec?: pulumi.Input<inputs.source.v1beta2.HelmChartSpecArgs>;
    /**
     * HelmChartStatus records the observed state of the HelmChart.
     */
    status?: pulumi.Input<inputs.source.v1beta2.HelmChartStatusArgs>;
}
